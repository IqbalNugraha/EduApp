...
class AnimalScreen extends StatefulWidget {
  static const routeName = '/option-animals';
...
class _AnimalScreenState extends State<AnimalScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<AnimalList>(context).getAnimals().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    final animalsData = Provider.of<AnimalList>(context);
    final animals = animalsData.list;
    return Scaffold(
      body: SizedBox(
